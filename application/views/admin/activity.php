                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td><?= $row['location'] ?></td>
                            <td>
                                <a href="<?= base_url('admin/deleteActivity/' . $row['id_activity']) ?>"
                                    class="btn btn-danger">Delete</a>
                                <a href="<?= base_url('admin/cancelActivity/' . $row['id_activity']) ?>"
                                    class="btn btn-info">Cancel Activity</a>
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#edit<?= $row['id_activity'] ?>">
                                    Edit
                                </button>
            ...
            <div class="modal-body">
                <form action="<?= base_url('admin/activity') ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="input" class="form-control" name="personResponsible" id="personResponsible"
...
<div class="modal fade" id="edit<?= $row['id_activity'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <form action="<?= base_url('admin/editActivity/' . $row['id_activity']) ?>" method="post">
                    <div class="mb-3">
                        <label for="nameOfActivity" class="form-label">Name of activity</label>
                        <input type="input" class="form-control" name="nameOfActivity"
                            value="<?= $row['nameOfActivity'] ?>">
                    </div>
                    <div class="mb-3">
                        <label for="personResponsible" class="form-label">Person responsible</label>
                        <input type="input" class="form-control" name="personResponsible" id="personResponsible"
